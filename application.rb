...
class Application < Sinatra::Base
  ...
  assets {
    ...
    js :application, '/js/application.js', %w( /js/jquery-1.9.1.js /js/bxslider.js /js/initializer.js /js/google_maps.js)
  ...
  post '/orders.json' do
    ...
    message += "\n"
    message += params[:order][:model]

    Pony.mail ({
        to: 'sms.m2014@yandex.ru, abardacha@gmail.com',
